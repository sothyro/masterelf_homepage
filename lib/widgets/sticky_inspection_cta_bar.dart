...
/// Floating vertical bar for Inspection Dashboard CTA. Shown when logged in.
class StickyInspectionCtaBar extends StatelessWidget {
  const StickyInspectionCtaBar({super.key});

  @override
  Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context)!;
    final path = GoRouterState.of(context).uri.path;
    final isActive = path == '/consultations/inspection-dashboard' ||
          ...
          child: InkWell(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Icon(LucideIcons.clipboardList, color: isActive ? AppColors.onAccent : AppColors.accent, size: 22),
